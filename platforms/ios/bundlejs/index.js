...
__vue_options__.__file = "/Users/pisces/weexTest/src/index.vue"
...
exports.default = {
    ...
    methods: {
        // 绘制红色区域
        renderRedRect: function renderRedRect() {
        ...
        // 直接使用 F2
        renderNativeF2: function renderNativeF2() {
            var ref = this.$refs.canvas_holder;
            if (isWeex) {
                ref = enable(ref, { bridge: WeexBridge });
            }
            ...
            var data = [{ genre: 'Sports', sold: 275 }, { genre: 'Strategy', sold: 115 }, { genre: 'Action', sold: 120 }, { genre: 'Shooter', sold: 350 }, { genre: 'Other', sold: 150 }];
        ...
        renderF2Extend: function renderF2Extend() {
            var ref = this.$refs.canvas_holder;
            if (isWeex) {
                ref = enable(ref, { bridge: WeexBridge });
            }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('text', [_vm._v("1111111111222")]), (_vm.isWeex) ? _c('gcanvas', {
    ref: "canvas_holder",
    staticStyle: {
      width: "750px",
      height: "400px"
